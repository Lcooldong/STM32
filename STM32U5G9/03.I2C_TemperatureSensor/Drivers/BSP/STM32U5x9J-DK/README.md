# BSP STM32U5X9J-DK Component

![latest tag](https://img.shields.io/github/v/tag/STMicroelectronics/stm32u5x9j-dk-bsp.svg?color=brightgreen)
...
This **stm32u5x9j-dk-bsp** MCU component repo is one element of the STM32CubeU5 MCU embedded software package, providing the STM32U5A9J-DK and the STM32U5G9J-DK1 parts.

## Release note

Details about the content of this release are available in the release note [here](https://htmlpreview.github.io/?https://github.com/STMicroelectronics/stm32u5x9j-dk-bsp/blob/main/Release_Notes.html).
